...
//  Généré depuis audit-config.json
//  15 chapitres — 60 questions
//
//  Fichier indépendant : modifiez-le sans toucher à index.html
//  Structure : chapitres > questions > options > paragraphes
//
//  "Non applicable" est disponible sur les questions à choix.
//  "Réponse libre" permet une saisie libre dans le questionnaire.
// ============================================================
...
const AUDIT_DATA = [
  {
    ...
    "questions": [
      {
        "id": 1775731331460,
        "text": "Cogep Informatique a été désigné comme Auditeur de l’infrastructure informatique du cabinet d’avocats JRF AVOCATS, situé 13 Rue Colbert, 78000 Versailles.\nDeux autres sites annexes sont présents mais ne feront pas parti de cet audit. Ils sont situés 10 Rue de Rome, 75018 Paris ainsi que 2 avenue Jean Jaurès, 92130 Issy Les Moulineaux.\nL’objectif est de prendre en main l’environnement et de détecter les points clés de l’infrastructure, pour ainsi souligner les points positifs et négatifs du SI. Nous utiliserons des outils internes afin de pouvoir compléter cet audit (scripts, outil de supervision, prise en main serveur, …) afin de compléter au maximum cet audit.\nIl a été mentionné par le client lors de l’interview que plusieurs cyberattaques ont eu lieu dans les dernières années (3) causant des problématiques de productivité et des pertes de données. Crife Informatique n’a jamais fourni d’éléments concernant la provenance et le scénario de ces attaques malgré la demande du client final.\nLe client nous a remonté quelques actions correctives à savoir l’achat d’un NAS pour une sauvegarde locale et également la mise à niveau des systèmes d’exploitation des serveurs.",
        "qtype": "freetext",
        "options": [],
        "paragraphs": {},
        "images": {},
  ...
  },
  {
    ...
    "questions": [
      {
        "id": 1775731353417,
        "text": "Le 03/02/2025 :  Audit technique sur place\nEntre le 03/02/2025 le 10/03/2025 : Préparation de la restitution de l’audit\nLe 31/03/2025 : Restitution de l’audit auprès des représentants de JRF AVOCATS\nPour ce planning, un outil de gestion de projet a été utilisé en interne nommé Gouti.",
        "qtype": "freetext",
        "options": [],
        "paragraphs": {},
        "images": {},
  ...
  },
  {
    ...
    "questions": [
      {
        "id": 1775745237373,
        "text": "Nous tenons à remercier JRF AVOCATS et ses collaborateurs pour leur disponibilité, tant lors de notre déplacement sur site le 03/02/2025 mais également pendant toute la période de rédaction où chaque question posée était répondue dans de très bons délais pour garantir le contenu de cet audit.",
        "qtype": "freetext",
        "options": [],
        "paragraphs": {},
        "images": {},
  ...
  {
    "id": 111,
    "name": "Tiers et prestataires",
    "questions": [
      {
        "id": 1775745343708,
        "text": "Prestataire de la maintenance et d'infogérance du parc",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
  ...
  {
    "id": 103,
    "name": "Parc Informatique : Postes de travail...",
    "questions": [
      {
        "id": 1775745653511,
        "text": "Habitude utilisateur et logiciels utilisés",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
      ...
      {
        "id": 1775745712378,
        "text": "Détail des applications métiers",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
      ...
      {
        "id": 1021,
        "text": "Les mises à jour de sécurité des systèmes d'exploitation (Windows 11...) sont-elles appliquées ? ",
        "options": [
          "Oui",
          "Non",
          "Partiel",
        ...
        "paragraphs": {
          "Oui": "Les mises à jour de sécurité critiques sont appliquées dans des délais maîtrisés (sous 30 jours pour les correctifs critiques), sur l'ensemble des systèmes.",
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "id": 1775745942443,
        "text": "Rôles du serveur physique ",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
      ...
      {
        "id": 1775746003776,
        "text": "Rôles des machines virtuelles",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "id": 1775746883313,
        "text": "Equipes et groupes (Teams/Sharepoint) ",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
      ...
      {
        "id": 1775746916420,
        "text": "Exchange : règles de redirection...",
        "qtype": "choice",
        "options": [
          "Réponse libre"
        ],
      ...
      },
      {
        ...
        "paragraphs": {
          "Oui": "",
          "Non": "Extrait des contrats de service Microsoft Contrat de Services Microsoft\nDisponibilité des Services.\na. Les Services, Applications et Services Tiers ou documents ou produits proposés via les Services peuvent s’avérer indisponibles de temps à autre, être offerts sur une base limitée ou peuvent varier en fonction de votre pays ou appareil ou d'autres facteurs externes tels que votre connexion Internet ou réseau. Si vous changez le lieu associé à votre compte Microsoft, vous devrez peut-être racheter les produits que vous avez achetés et payés dans votre précédente région.\nb. Nous mettons tout en œuvre pour assurer la disponibilité permanente des Services. Toutefois, ils ne sont pas offerts avec un niveau de qualité de service garanti et aucun service en ligne n’est à l’abri d’interruptions et de pannes. En cas de panne ou d'interruption du Service, vous pouvez temporairement ne pas être en mesure de récupérer Votre Contenu. Nous vous recommandons de sauvegarder régulièrement Votre Contenu et vos Données que vous stockez sur les Services ou que vous stockez en utilisant des Applications et Services Tiers."
        },
        "images": {}
      }
    ]
  ...
  {
    "id": 106,
    "name": "Sauvegarde et continuité d'activité",
    "questions": [
      {
        "id": 1050,
  ...
  {
    "id": 105,
    "name": "Protection des données, sensibilisation et pratiques",
    "questions": [
      {
        "id": 1040,
  ...
  {
    "id": 101,
    "name": "Politique de sécurité et gouvernance",
    "questions": [
      {
        "id": 1001,
        ...
        "images": {
          "Oui": {
            "url": "/uploads/img_5e651f1b3aa33782.png",
            "filename": "img_5e651f1b3aa33782.png",
            "name": "Matrice de robustesse des mots de passe",
            "caption": ""
          }
        }
      },
    ...
    "questions": [
      {
        ...
        "images": {
          "Non": {
            "url": "/uploads/img_4d31c19b10146094.png",
            "filename": "img_4d31c19b10146094.png",
            "name": "Matrice de robustesse des mots de passe",
            "caption": "Matrice de robustesse des mots de passe"
          },
          "Partiel": {
            "url": "/uploads/img_4d31c19b10146094.png",
            "filename": "img_4d31c19b10146094.png",
  ...
  {
    "id": 109,
    "name": "Messagerie et protection contre le phishing",
    "questions": [
      {
        "id": 1081,
      ...
      },
      {
        ...
        "paragraphs": {
          ...
          "Non": "Aucun filtrage efficace des emails n'est en place. La messagerie est le premier vecteur d'attaque. La mise en place d'une solution de protection et la configuration des enregistrements SPF, DKIM et DMARC sont des actions prioritaires.",
          "Partiel": "",
          "Non applicable": "Des filtres existent mais sont insuffisants ou mal configurés. Les enregistrements DNS ne sont pas tous en place ou DMARC est en mode monitoring sans rejet. Un renforcement de la protection est recommandé."
        },
        "images": {}
      }
    ]
  ...
  {
    "id": 110,
    "name": "Journalisation et supervision",
    "questions": [
      {
        "id": 1090,
